...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(255,255,255,0)","#FFFFFF"],[0,1],-23.7,0,23.8,0).s().p("AjtAKIAAgTIHbAAIAAATg");
	this.shape.setTransform(23.75,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol33, new cjs.Rectangle(0,0,47.5,2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_17.setTransform(724,513.95,1,1,0,0,180,23.8,1);

	this.instance_18 = new lib.Symbol33();
	this.instance_18.setTransform(25.3,513.95,1,1,0,0,0,23.8,1);

	this.instance_19 = new lib.Arrows();
	this.instance_19.setTransform(619.75,513.05,1,1,0,0,0,27.1,11.4);

	this.instance_20 = new lib.Group_1();
	this.instance_20.setTransform(620.7,519.55,1,1,0,0,180,59.6,285.7);
	this.instance_20.alpha = 0.5;

	this.instance_21 = new lib.Group_1();
	this.instance_21.setTransform(143.1,519.55,1,1,0,0,0,59.6,285.7);
	this.instance_21.alpha = 0.5;

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#F9F9F9").ss(1,1,1).p("EAXigrUUAjaArngi4ArCEgXhgrUUgjaArnAi4ArC");
	this.shape.setTransform(381.8994,514.875);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17}]}).wait(142));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(376.5,604.4,371.29999999999995,426.5000000000001);
// library properties:
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/new_vectors_atlas_1.png?1619627853921", id:"new_vectors_atlas_1"}
	],
	preloads: []
};
